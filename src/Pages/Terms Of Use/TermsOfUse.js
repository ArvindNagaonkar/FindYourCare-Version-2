  ...
  return (
    <div className="TeramsOfUse">
      ...
      <p>
        ...
        alloiono does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of alloiono,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, alloiono shall not be liable
      ...
      <p>
        alloiono reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant alloiono a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of alloiono; and (d) the link is
      ...
      <p>
        ...
        e-mail to alloiono. Please include your name, your organization name,
      ...
      <p>
        No use of alloiono’s logo or other artwork will be allowed for linking
